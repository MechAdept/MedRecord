...
VALUES (1, 'ROLE_USER'),
       ...
       (3, 'ROLE_PATIENT'),
       (20, 'ROLE_MEDIC'),
       (21, 'ROLE_EXAMPLE1444444');
INSERT INTO `user`
VALUES (4, 'Username', '$2a$11$g9Zb/tf8UaqKqsMw6X6Gieh1BidOmCVHL7RUadRIyoJ/Af9wTEexC'),
       (5, 'NewUsername', '$2a$11$FNmAIsmKFjQLmKBCDVpg0exbDysE0fxRNHNSsdQ833LsnMIzXzeFm'),
       (6, 'NewName', '$2a$11$yI75hVAkWH9DMGTy2Q9Ig.BeADcIXjZELRRmORQ09ZfWHf7AeHi3.'),
       (7, '123456', '$2a$11$DQvk17GQ3PKNCfVmAD5/reCQYYvaPwQMCo99L4v96lt6TL2f6yll2'),
       (8, '654321', '$2a$11$kYv3KyqXFuduklYC1cezV.sdPmPELjbIuOI7piB7kf9SHTZ9R6BeC'),
       (9, '12345678', '$2a$11$2Xx1iFBPtdcrJNFVCZk0PubC2b8.hqgjAP87DGTg.BXGikVeB28cm'),
       (11, '11111111', '$2a$11$jL1Yu.G1Y3JT3uqbfSHZXOw4RdKq4Ux4FmMFvq3CtBiJ7W2LfNnJC'),
       (16, '87654321', '$2a$11$AM2B2y5x5n.zW552LFf46uJV/0iVM9z7fMo8kheyYY3egPRmANkW.'),
       (18, 'FirstCreateUser', '$2a$11$EDETgZyKXT7moOzC5Hn/IOUq7I4Pglkk05l2Hi7XZeaDp8xH0y0qS'),
