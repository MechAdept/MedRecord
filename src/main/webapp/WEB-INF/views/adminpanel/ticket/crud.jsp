...
<head>
    ...
    <title><spring:message code="text.title.ticketCrud"/></title>
    ...
    <div class="row" style="margin-top: 10px">
        ...
        <div class="col-xs-4">
            <c:if test="${DTOList.size() != 0}">
                ...
                <spring:message code="text.info.items"/> ${elementsCount}<spring:message
    ...
    <table class="table">
        ...
        <tr>
            <th scope="col">
                <c:if test="${desc == false}">
                    <a href="<c:url value="/adminpanel/ticket?pageNo=${pageNo}&pageSize=${pageSize}&desc=${true}&sort=id"/>"><spring:message
                            code="text.label.id"/></a>
                </c:if>
                <c:if test="${desc == true}">
                    <a href="<c:url value="/adminpanel/ticket?pageNo=${pageNo}&pageSize=${pageSize}&desc=${false}&sort=id"/>"><spring:message
                            code="text.label.id"/></a>
                </c:if>
            </th>
            <th scope="col">
                <c:if test="${desc == false}">
                    <a href="<c:url value="/adminpanel/ticket?pageNo=${pageNo}&pageSize=${pageSize}&desc=${true}&sort=doctor"/>"><spring:message
                            code="text.label.doctor"/></a>
                </c:if>
                <c:if test="${desc == true}">
                    <a href="<c:url value="/adminpanel/ticket?pageNo=${pageNo}&pageSize=${pageSize}&desc=${false}&sort=doctor"/>"><spring:message
                            code="text.label.doctor"/></a>
                </c:if>
            </th>
            <th scope="col">
                <c:if test="${desc == false}">
                    <a href="<c:url value="/adminpanel/ticket?pageNo=${pageNo}&pageSize=${pageSize}&desc=${true}&sort=patient"/>"><spring:message
                            code="text.label.patient"/></a>
                </c:if>
                <c:if test="${desc == true}">
                    <a href="<c:url value="/adminpanel/ticket?pageNo=${pageNo}&pageSize=${pageSize}&desc=${false}&sort=patient"/>"><spring:message
                            code="text.label.patient"/></a>
                </c:if>
            </th>
            <th scope="col">
                <c:if test="${desc == false}">
                    <a href="<c:url value="/adminpanel/ticket?pageNo=${pageNo}&pageSize=${pageSize}&desc=${true}&sort=datetime"/>"><spring:message
                            code="text.label.datetime"/></a>
                </c:if>
                <c:if test="${desc == true}">
                    <a href="<c:url value="/adminpanel/ticket?pageNo=${pageNo}&pageSize=${pageSize}&desc=${false}&sort=datetime"/>"><spring:message
                            code="text.label.datetime"/></a>
                </c:if>
            </th>
            <th scope="col"></th>
        ...
        <c:forEach items="${DTOList}" var="ticket">
            <tr>
                ...
                <th scope="row">
                    <a href="<c:url value="/adminpanel/user/details/${ticket.doctor.id}"/>" class="btn-sm btn-primary"
                       role="button"
                ...
                <th scope="row">
                    <a href="<c:url value="/adminpanel/user/details/${ticket.patient.id}"/>" class="btn-sm btn-primary"
                       role="button"
                ...
                <td>
                    <a href="<c:url value="/adminpanel/ticket/delete/${ticket.id}/?${pageNo}&${pageSize}&${desc}&${sort}"/>"
