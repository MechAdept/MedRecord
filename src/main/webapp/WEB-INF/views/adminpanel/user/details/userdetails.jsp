...
<div class="container">
    ...
    <div class="container" style="margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-xs-2" style="text-align: center">
                <a href="<c:url value="/adminpanel/user/details/${userDTO.id}/roles"/>" class="btn-sm btn-primary" role="button"
                   aria-pressed="true">Роли</a>
                <a href="<c:url value="/adminpanel/user/details/${userDTO.id}/tickets"/>" class="btn-sm btn-primary" role="button"
                   aria-pressed="true">Талоны</a>
            </div>
            <div class="col-xs-3" style="text-align: center">
                <td><a href="<c:url value="/adminpanel/user/delete/${userDTO.id}"/>" class="btn btn-link" role="button" aria-pressed="true">delete</a>
                </td>
                <td><a href="<c:url value="/adminpanel/user/edit/${userDTO.id}"/>" class="btn btn-link" role="button" aria-pressed="true">edit</a>
                </td>
            </div>
